...
const GAIN_WEIGHTS = [0.5, 0.1, 0.1, 0.1];
const FREQUENCIES = [440, 0, 0, 0];
...
const FREQUENCY_WINDOW_POSITION_MIN = 250;
const FREQUENCY_WINDOW_POSITION_MAX = 22500;
...
function frame() {
  ...
  drawTimeDomainViz(canvasContext, 0, 0, WIDTH, HEIGHT, timeDomainSnapshot);
}
